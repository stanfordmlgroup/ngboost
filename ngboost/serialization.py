...
# UBJSON availability is checked in ngboost.py where it's actually used
# This module doesn't need to import ubjson directly
...
def tree_from_dict(tree_dict: Dict[str, Any]) -> DecisionTreeRegressor:
    ...
    try:
        ...
        raise ValueError(
            f"Failed to decode tree data: {e}. " "The model file may be corrupted."
        ) from e
